...
**I used a StatefulSet instead of a Deployment** to ensure deterministic identities for the NimP2P pods in each experiment (e.g., `nimp2p-0`, `nimp2p-1`, …, `nimp2p-N` for the first, second, and N-th pods) and maintain these identities even after rescheduling.
